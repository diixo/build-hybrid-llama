...
def main():
    ...
    # Load dataset from local JSONL file (each line is a JSON object with a 'text' field)
    def load_local_json_dataset(path: str):
    ...
    eli5 = load_local_json_dataset("dataset.jsonl")
